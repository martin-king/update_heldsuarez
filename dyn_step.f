...
C--
cmpk modify for held suarez based on cmpkhs 
      include "atparam.h"
      include "atparam1.h"
...
cmpk      SDRAG=1./(TDRS*3600.)
cmpk      DO N=1,NX
cmpk        VORDT(1,N,1)=VORDT(1,N,1)-SDRAG*VOR(1,N,1,1)
cmpk        DIVDT(1,N,1)=DIVDT(1,N,1)-SDRAG*DIV(1,N,1,1)
cmpk      ENDDO

cmpk      CALL HORDIF (1,VOR, VORDT,DMPS,DMP1S)
cmpk      CALL HORDIF (1,DIV, DIVDT,DMPS,DMP1S)
cmpk      CALL HORDIF (1,CTMP,TDT,  DMPS,DMP1S)
